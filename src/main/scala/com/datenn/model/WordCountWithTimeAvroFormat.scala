...
object WordCountWithTimeAvroFormat {
  val SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"WordCountWithTimeAvroFormat\",\"namespace\":\"com.datenn.model\",\"fields\":[{\"name\":\"word\",\"type\":\"string\"},{\"name\":\"count\",\"type\":\"int\"},{\"name\":\"time\",\"type\":\"long\"},{\"name\":\"dt\",\"type\":\"string\"}]}")
}
